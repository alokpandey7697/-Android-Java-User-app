...
import com.alok.alok.models.UsersCurrentLocation;
...
public class LaunchMap extends AppCompatActivity implements OnMapReadyCallback {
...
//                finish();
                if(add != null && lattitude != 0 && longitude != 0){
                    Prevalent.currentOnlineUsersLocation = new UsersCurrentLocation(add, lattitude, longitude);
                    Intent intent = new Intent(LaunchMap.this, storeList.class);
                    ...
                    if(checkGPSStatus(getApplicationContext())) {
                        ...
                        Toast.makeText(LaunchMap.this, "Enable GPS ", Toast.LENGTH_SHORT).show();
                    }
               ...
               /* Intent returnIntent = new Intent();
                ...
                returnIntent.putExtra("TotalPrice", overallAmount);
                Log.d("totalMap",String.valueOf(overallAmount));
    ...
    private void getCurrentLocation() {
        ...
        LocationServices.getFusedLocationProviderClient(LaunchMap.this)
    ...
    private class AddresssResultReceiver extends ResultReceiver {
        ...
        protected void onReceiveResult(int resultCode, Bundle resultData) {
            ...
            if(resultCode == Constants.SUCESS_RESULT) {
                ...
                else {                Toast.makeText(LaunchMap.this, "Retry ", Toast.LENGTH_SHORT).show();
                }
            }
            progressBar.setVisibility(View.GONE);
        }
