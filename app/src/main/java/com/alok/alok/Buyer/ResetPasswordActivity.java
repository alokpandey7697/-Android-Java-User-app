        ...
        else
        {
            ...
            ref.child("Security Questions").updateChildren(userdataMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    ...
                    {
                        Toast.makeText(ResetPasswordActivity.this, "You have answer the questions successfully", Toast.LENGTH_SHORT).show();
                   ...
                   public void onDataChange(@NonNull DataSnapshot dataSnapshot)
                   {
                       if(dataSnapshot.exists())
                       {
                           ...
                           if(dataSnapshot.hasChild("Security Questions"))
                           {
                               ...
                               Toast.makeText(ResetPasswordActivity.this, "You have not set the questions.Please try again", Toast.LENGTH_SHORT).show();
                           }
                       }
                       else{
